...
{
    public class InventoryIncreaseEventServiceslmpl : InventoryIncreaseEventServices
    {
        private static readonly InventoryIncreaseEventRepository repository = new InventoryIncreaseEventRepositorylmpl();
